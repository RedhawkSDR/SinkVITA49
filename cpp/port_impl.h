...
// ----------------------------------------------------------------------------------------
// BULKIO_dataVITA49_Out_i declaration
// ----------------------------------------------------------------------------------------
class BULKIO_dataVITA49_Out_i : public Port_Uses_base_impl, public virtual POA_BULKIO::UsesPortStatisticsProvider
{
    public:
        BULKIO_dataVITA49_Out_i(std::string port_name, SinkVITA49_base *_parent);
        ~BULKIO_dataVITA49_Out_i();
...
{
    public:
        BULKIO_dataUshort_In_i(std::string port_name, SinkVITA49_base *_parent);
...
{
    public:
        BULKIO_dataShort_In_i(std::string port_name, SinkVITA49_base *_parent);
...
{
    public:
        BULKIO_dataChar_In_i(std::string port_name, SinkVITA49_base *_parent);
...
{
    public:
        BULKIO_dataDouble_In_i(std::string port_name, SinkVITA49_base *_parent);
...
{
    public:
        BULKIO_dataFloat_In_i(std::string port_name, SinkVITA49_base *_parent);
...
{
    public:
        BULKIO_dataOctet_In_i(std::string port_name, SinkVITA49_base *_parent);
