...
class SinkVITA49_base : public Resource_impl
{
    ...
    friend class BULKIO_dataVITA49_Out_i;
    ...
    protected:
        ProcessThread<SinkVITA49_base> *serviceThread; 
        ...
        BULKIO_dataVITA49_Out_i *dataVITA49_out;
